...
\author{Igor Hanus \\ \href{mailto:xhanus19@stud.fit.vutbr.cz}{xhanus19@stud.fit.vutbr.cz}}
\date{}
...
\begin{quotation}
Čím více \emph{druhů}, \textbf{řezů}, {\tiny velikostí}, {\color{red} barev} 
písma a~jiných \textsc{efektů} použijeme, tím 
\texttt{profesionálněji} bude {\Large\fontfamily{pzc}\selectfont dokument} vypadat.
{\huge Č}{\LARGE t}{\Large e}{\large n}ář {\footnotesize t}{\scriptsize í}{\tiny m} bude vždy {\Huge\textbf{nadšen!}}
\end{quotation}
...
V~češtině se používají uvozovky typu \uvcs{9966} místo anglických ``uvozovek'' nebo dvojitých "uvozovek".
...
Spojkou \uvcs{a} končit může pouze při sazbě do šířky 25 liter.
...
Pro systematické doplnění vlnek slouží volně šiřitelný program \textit{vlna} od pana Olšáka\footnote{\href{http://petr.olsak.net/ftp/olsak/vlna/}{Viz \texttt{http://petr.olsak.net/ftp/olsak/vlna/}}}.
